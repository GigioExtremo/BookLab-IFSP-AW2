<?php
    ...
    $reqRows = $requisicaoService->getRequisicoesRows();
...
<body>
    ...
    <div class="container">
        ...
        <div class="title">Requisições </div> <br>
        ...
        <div class="request">
            <table id="este-mes">
                ...
                <tr class="acoes">
                    ...
                    <td class="falar-prof"> <button type="button" class="modalbtn" data-toggle="modal" data-target="#meuModal">Falar com Professor</button></td>
                    <td> </td>
                    <td> </td>
                    <td> </td>
                </tr>
